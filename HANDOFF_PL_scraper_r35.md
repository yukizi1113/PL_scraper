# HANDOFF_PL_scraper_r35.md

## 概要
- 作業ディレクトリ: `C:\Users\hp\Documents\Investment`
- 最新スクリプト: `pl_scraper_3files_r35.py`
...
## 主要なコード位置
- バージョン更新: `pl_scraper_3files_r35.py:64`
- EDINET キー候補解決: `pl_scraper_3files_r35.py:149`
- EDINET preflight 認証統一 / 有効キー返却: `pl_scraper_3files_r35.py:4624`
- `genka` 候補の信頼性判定: `pl_scraper_3files_r35.py:3087`
- `genka` に対するCF注記優先: `pl_scraper_3files_r35.py:3342`

## 既知事項
- `python -m py_compile pl_scraper_3files_r35.py` は通過

## ファイル
- 実装: `pl_scraper_3files_r35.py`
- 引継ぎ: `HANDOFF_PL_scraper_r35.md`
- 検証出力:
